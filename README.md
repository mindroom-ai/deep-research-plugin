...
- The reasoner can promote snippet-backed candidates into citable unvetted sources (`cite_snippet_urls`) without spending a page read — corroborating coverage it relies on no longer ends up uncited — and is nudged to spend its reads on primary sources
