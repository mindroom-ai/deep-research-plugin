...
time. Minimum runtime: MindRoom v2026.7.38.
"""
...
def test_runtime_provides_typed_worker_target_api() -> None:
    """MindRoom >= v2026.7.38: worker-target resolution and public scope accessor."""
    assert callable(ToolRuntimeContext.resolve_worker_target)
    assert callable(Config.agent_execution_scope)
